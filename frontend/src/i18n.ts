...
export type NavKey = 'overview' | 'bookings' | 'schedule' | 'machines' | 'requests' | 'tasks' | 'people' | 'profile'
...
export const translations: Record<Language, Translation> = {
  en: {
    ...
    nav: { overview: 'Overview', bookings: 'Bookings', schedule: 'Schedule', machines: 'Machines', requests: 'My requests', tasks: 'Assigned jobs', people: 'People', profile: 'My profile' },
  ...
  hi: {
    ...
    nav: { overview: 'अवलोकन', bookings: 'बुकिंग', schedule: 'शेड्यूल', machines: 'मशीनें', requests: 'मेरे अनुरोध', tasks: 'सौंपे गए काम', people: 'लोग', profile: 'मेरी प्रोफ़ाइल' },
  ...
  ta: {
    ...
    nav: { overview: 'மேலோட்டம்', bookings: 'முன்பதிவுகள்', schedule: 'அட்டவணை', machines: 'இயந்திரங்கள்', requests: 'எனது கோரிக்கைகள்', tasks: 'ஒதுக்கப்பட்ட பணிகள்', people: 'பயனர்கள்', profile: 'எனது சுயவிவரம்' },
