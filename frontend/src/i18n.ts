...
export type NavKey = 'overview' | 'bookings' | 'schedule' | 'machines' | 'tracking' | 'requests' | 'tasks' | 'people' | 'profile' | 'help'
...
export const translations: Record<Language, Translation> = {
  en: {
    ...
    nav: { overview: 'Overview', bookings: 'Bookings', schedule: 'Schedule', machines: 'Machines', tracking: 'Live tracking', requests: 'My requests', tasks: 'Assigned jobs', people: 'People', profile: 'My profile', help: 'Help & support' },
  ...
  hi: {
    ...
    nav: { overview: 'अवलोकन', bookings: 'बुकिंग', schedule: 'शेड्यूल', machines: 'मशीनें', tracking: 'लाइव ट्रैकिंग', requests: 'मेरे अनुरोध', tasks: 'सौंपे गए काम', people: 'लोग', profile: 'मेरी प्रोफ़ाइल', help: 'सहायता' },
  ...
  ta: {
    ...
    nav: { overview: 'மேலோட்டம்', bookings: 'முன்பதிவுகள்', schedule: 'அட்டவணை', machines: 'இயந்திரங்கள்', tracking: 'நேரடி கண்காணிப்பு', requests: 'எனது கோரிக்கைகள்', tasks: 'ஒதுக்கப்பட்ட பணிகள்', people: 'பயனர்கள்', profile: 'எனது சுயவிவரம்', help: 'உதவி மற்றும் ஆதரவு' },
