...
const labels: Record<string, string> = { PENDING: 'Pending', APPROVED: 'Approved', ASSIGNED: 'Assigned', IN_PROGRESS: 'In progress', COMPLETED: 'Completed', CANCELLED: 'Cancelled', ACTIVE: 'Active', MAINTENANCE: 'Maintenance', BROKEN: 'Broken' }
